/**
 * SharkMotion Studio - Modular macOS-Style Popover Controller
 * Features:
...
const Popover = (function () {
  ...
  function updatePosition() {
    ...
    // Special Case: On Mobile, SharkMotion embed panel pops UPWARD to completely fill upper preview area
  ...
  return {
    ...
    toggle,
    updatePosition,
    initTriggers: initPopoverTriggers,
