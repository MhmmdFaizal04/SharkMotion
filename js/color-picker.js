/**
 * SharkTool Studio - Universal Color Picker Popover
...
(function(global) {
  ...
  class ColorPickerComponent {
    ...
    _loadSavedSwatches() {
      try {
        const saved = localStorage.getItem('sharkmotion:custom-swatches');
    ...
    _saveSwatches() {
      try {
        localStorage.setItem('sharkmotion:custom-swatches', JSON.stringify(this.savedSwatches));
      } catch (_) {}
    }
  ...
  global.SharkColorPicker = SharkColorPicker;
