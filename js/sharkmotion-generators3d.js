/**
 * SharkTools Studio - Procedural 3D Generators Engine
...
(function (root) {
  ...
  function wrapIn3DPrecomp({
    ...
    if (root.SharkDatabase && typeof root.SharkDatabase.saveMedia === 'function' && state.id) {
      root.SharkDatabase.saveMedia(precompMediaItem).catch(err => {
        console.warn('[SharkTools3D] saveMedia error:', err);
      });
    }
  ...
  // 1. CUBE GENERATOR
  // =========================================================================
  SharkTools3D.createProceduralCube = function (w, h, d, useLayer = false) {
    const state = root.currentProjectState || {};
  ...
  // =========================================================================
  SharkTools3D.createProcedural3D = function (type) {
  ...
  // =========================================================================
  SharkTools3D.createProceduralMC = function () {
    const state = root.currentProjectState || {};
    const layers = state.layers || [];
    const selId = root.selectedLayerId;
    const selLayer = layers.find(l => l.id === selId);
  ...
  // =========================================================================
  SharkTools3D.createProcedural2Split = function () {
    const state = root.currentProjectState || {};
    const layers = state.layers || [];
    const selId = root.selectedLayerId;
    const selLayer = layers.find(l => l.id === selId);
  ...
  SharkTools3D.createProcedural3Split = function () {
    const state = root.currentProjectState || {};
    const layers = state.layers || [];
    const selId = root.selectedLayerId;
    const selLayer = layers.find(l => l.id === selId);
  ...
  SharkTools3D.createProceduralTunnel = function () {
    const state = root.currentProjectState || {};
    const layers = state.layers || [];
    const selId = root.selectedLayerId;
    const selLayer = layers.find(l => l.id === selId);
  ...
  root.SharkTools3D = SharkTools3D;
  root.FishTools3D = SharkTools3D;
  root.createProceduralCube = SharkTools3D.createProceduralCube;
  root.createProcedural3D = SharkTools3D.createProcedural3D;
  root.createProcedural2Split = SharkTools3D.createProcedural2Split;
  root.createProcedural3Split = SharkTools3D.createProcedural3Split;
  root.createProceduralTunnel = SharkTools3D.createProceduralTunnel;
  root.createProceduralMC = SharkTools3D.createProceduralMC;
