...
function setupDonation() {
    ...
    var socialLinks = {
        'btn-yt': 'https://www.youtube.com/@SharkMotion',
        'btn-tt-aep': 'https://www.tiktok.com/@SharkMotion',
        'btn-tt-rbx': 'https://www.tiktok.com/@SharkMotion',
        'btn-ig': 'https://www.instagram.com/SharkMotion',
        'btn-gh': 'https://www.github.com/SharkMotion'
    };
...
function showPermissionModal() {
    ...
    desc.textContent = 'SharkMotion Tools needs write access to save your settings, presets, and graph data. Please enable it in After Effects preferences.';
