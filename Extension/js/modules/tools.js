...
(function () {
    var NS = (typeof window !== 'undefined' && window.SharkTools) ? "SharkTools" : "FishTools";
    ...
    ToolboxModule.prototype.init = function () {
        try {
            ...
            console.warn('[SharkTools] CSInterface init warning:', e);
            this.csInterface = null;
        }
    ...
    ToolboxModule.prototype._runTool = function (toolName) {
        ...
        // Resilient fallback: direct execution if csInterface is unavailable
        var execDirect = (typeof window !== 'undefined' && window.SharkTools && typeof window.SharkTools.executeTool === 'function')
            ? window.SharkTools.executeTool
            : ((typeof window !== 'undefined' && window.FishTools && typeof window.FishTools.executeTool === 'function')
                ? window.FishTools.executeTool
                : ((typeof window !== 'undefined' && window.parent && typeof window.parent.executeSharkTool === 'function')
                    ? window.parent.executeSharkTool
                    : null));

        if (!this.csInterface && typeof execDirect === 'function') {
            try {
                return execDirect.apply(window.SharkTools || window.FishTools || window.parent, [toolName].concat(args));
            } catch (err) {
                console.error('[SharkTools] Direct execution error:', err);
            }
        }
