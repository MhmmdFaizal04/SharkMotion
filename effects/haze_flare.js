  ...
  reg.register({
    ...
    render(ctx, el, layer, bounds, fx) {
      ...
      for (let i = 0; i < passes.length; i++) {
        ...
        if (typeof window !== 'undefined' && window.SharkEffects && typeof window.SharkEffects.drawBlurred === 'function') {
          window.SharkEffects.drawBlurred(halo.x, bloom.c, w, h, p.radius);
        } else {
          try {
