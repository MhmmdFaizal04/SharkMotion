/**
 * effects/fsmb.js
 * Shark Studio Motion Blur (FSMB) - Professional RSMB-Grade Motion Blur Plugin & Engine
 * 
 * Features:
...
(function(window) {
  ...
  const engine = new SharkSMBEngine();
  window.SharkSMBEngine = engine;
  window.FSMBEngine = engine;

  // Register Effect Plugin into SharkEffectsRegistry
