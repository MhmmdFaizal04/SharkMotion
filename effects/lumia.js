(function(window) {
  ...
  reg.register({
    ...
    renderPost(ctx, el, layer, bounds, fx) {
      ...
      if (blurVal > 0 && typeof window !== 'undefined' && window.SharkEffects && typeof window.SharkEffects.drawBlurred === 'function') {
        window.SharkEffects.drawBlurred(ctx, _lumiaCanvas, rw, rh, blurVal);
      } else {
