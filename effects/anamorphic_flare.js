    ...
    render(ctx, el, layer, bounds, fx) {
      ...
      for (let i = 0; i < passes.length; i++) {
        ...
        if (typeof window !== 'undefined' && window.SharkEffects && typeof window.SharkEffects.isCanvasFilterSupported === 'function' && window.SharkEffects.isCanvasFilterSupported()) {
          ...
          try { streak.x.drawImage(thresh.c, 0, 0, w, h, 0, 0, sw, h); } catch (_) {}
          if (vBlur > 1.0 && typeof window !== 'undefined' && window.SharkEffects && typeof window.SharkEffects.drawBlurred === 'function') {
            window.SharkEffects.drawBlurred(streak.x, streak.c, sw, h, vBlur);
          }
        }
        streak.x.restore();
