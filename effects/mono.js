(function(window) {
  ...
  reg.register({
    ...
    render(ctx, el, layer, bounds, fx, currentSec) {
      ...
      if (tintAmt <= 0 && contrast === 0 && brightness === 0 && typeof window !== 'undefined' && window.SharkEffects && typeof window.SharkEffects.isCanvasFilterSupported === 'function' && window.SharkEffects.isCanvasFilterSupported()) {
        ctx.save();
